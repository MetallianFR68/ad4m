window['lego-ev3-l-motor_init'] = function (tab, device)
{
	if (device.image)
		document.getElementById(tab.id + '_' + device.id + '_box').style.backgroundImage = "url('" + device.image + "')"
	else
		document.getElementById(tab.id + '_' + device.id + '_box').style.backgroundImage = "url('/modules/lego-ev3-l-motor/image.png')"
...
window['lego-ev3-l-motor_update'] = function(tab, device)
{
